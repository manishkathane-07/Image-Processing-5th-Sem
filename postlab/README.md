...
4. Configure settings:
   - **Root Directory:** Click **Edit** and choose **`postlab`** (or leave as `./` since root automatically redirects to `postlab`)
...
```
Image-Processing-5th-Sem/
├── index.html               # Root redirect to ./postlab/
├── README.md                # Project documentation & deployment guide
├── .gitignore               # Git ignored patterns
└── postlab/                 # All Virtual Laboratory project files
    ...
    ├── server.js            # Zero-dependency local Node HTTP server
